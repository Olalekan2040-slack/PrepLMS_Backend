...
urlpatterns = [
    ...
    path('profile/', UserProfileView.as_view(), name='user-profile'),    path('admins/', AdminListView.as_view(), name='admin-list'),
    path('admins/me/', AdminProfileView.as_view(), name='admin-profile'),
